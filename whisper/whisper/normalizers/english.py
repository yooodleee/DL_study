...
class EnglishTextNormalizer:
    ...
    def __call__(self, s: str):
        ...
        s = re.sub(r"\s+", "'", s)  # when there's space before an apostrophe
        ...
        s = remove_symbols_and_diacritics(s, keep=".%$¢€£") # keep numberic symbols

        s = self.standardize_numbers(s)
        s = self.standardize_spellings(s)

        # now remove prefix/suffix symbols that are not 
        # preceded/followed by numbers
