    ...
    def interface_result(
            ...
            for segment in result["segments"]:
                ...
                while chunk_index < len(segment["words"]):
                    ...
                    if max_words_per_line \
                        > len(segment["words"]) - chunk_index:
                        words_count = remaining_words
                    for i, origianl_timing in enumerate(
                        segment["words"][chunk_index : 
                                        chunk_index + words_count]):
                        timing = origianl_timing.copy()
        ...
        if len(result["segments"]) > 0 and "words" in result["segments"][0]:
            for subtitle in iterate_subtitles():
                ...
                subtitle_end = self.format_timestamp(subtitle[0]["end"])
